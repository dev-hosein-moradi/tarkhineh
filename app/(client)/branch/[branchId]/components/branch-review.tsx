    ...
    <div className="py-16">
      ...
      <div className="relative h-[300px] sm:h-[400px]">
        <Image
          ...
          loading="lazy"
          placeholder="blur"
          blurDataURL={fakeBlurDataURL} // Use a low-quality image or generate a base64 string
          className="brightness-50 w-full h-full object-cover"
        />
        <div className="bg-white w-full sm:w-[80%] md:w-[70%] absolute translate-x-[-50%] left-[50%] -bottom-5 mx-auto h-20 sm:h-24 rounded border-main border flex flex-col sm:flex-row sm:items-center justify-around px-2">
